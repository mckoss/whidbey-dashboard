...
test('ferry history page — serves dated table and time-distance diagram UI', async () => {
  ...
  assert.match(html, /const title = `\$\{terminal\} departures`/, 'labels each terminal departure table');
  ...
  assert.match(html, /missedTrips\.push/, 'passes overtaken scheduled departures into the table renderer');
